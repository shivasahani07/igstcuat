angular.module('cp_app').controller('ProjectDetailsSing_Ctrl', function($scope,$rootScope) {
    ...
    $scope.saveProjectDetailsSing=function(){
      ...
      if($scope.objRtf[1].charCount > 1000){
        ...
        if ($scope.objProposal.Duration_In_Months_Max_36__c == undefined || $scope.objProposal.Duration_In_Months_Max_36__c == "" || $scope.objProposal.Duration_In_Months_Max_36__c == 0){
    ...
    $scope.restrictDecimalVal = function(myVar){
      ...
      if(myVar>12 || myVar==0 || myVar == null){
          return false;
      }
      else
      {
